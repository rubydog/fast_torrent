describe 'Choker' do
  ...
  describe 'timers' do
    ...
    it 'should create a periodic timer for every 10 secs' do
  ...
  def mock_peer(down_rate, up_rate, interested)
    mock(PeerConnection, down_rate: down_rate, peer_interested?: interested,
         choked?: true, unchoke!: true, up_rate: up_rate, choke!: true)
  end
